              ...
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <div class="card-body" style="text-align: left">
                      <h5 class="col-sm-3" style="color: #0a6b3a">
                        <b>รายงานผล</b>
                      </h5>
                      <div
                        class="mb-3"
...
export default {
  ...
  mounted() {
    ...
    axios
      ...
      .then((response) => {
        ...
        let page =
          moment().format("YYYY") - this.patient2.birthDate.split("-")[0];
  ...
  methods: {
    ...
    saveComment() {
      ...
      axios
        .post(`https://cancer-api.gadoz.dev/giveMed`, data2)
        .then((response) => {
