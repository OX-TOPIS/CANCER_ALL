<template>
    <div class="row g-0 text-center">
        ...
        <div class="d-flex flex-column justify-content-center align-items-center" style="min-height: calc(100vh - 63px);">
            <div class="border rounded shadow p-3" style="margin: 50px; width: 60%;" >
                ...
                <button class="btn btn-success text-white" type="button" style="margin-right: 10px;" @click="submitFile">
                    นำเข้าข้อมูลผู้ป่วย
                </button>
                    </div>
            ...
            <div class="border rounded shadow p-3" style="margin: 50px; width: 60%;">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <button class="btn btn-success text-white" type="button" @click="showExportPopup">
                    ส่งออกข้อมูลผู้ป่วย
                    </button>
                </div>
