                      ...
                      <div class="mb-3 row" style="text-align: left">
                        ...
                        <div class="col-sm-8">
                          <input
                            ...
                            class="form-control"
                            id="inputText"
                            v-model.number="addNumberOfRound"
                          />
                        </div>
                      </div>
                      <div class="mb-3 row" style="text-align: left">
                        ...
                        <div class="col-sm-8">
                          <input
                            ...
                            class="form-control"
                            id="inputText"
                            v-model.number="addPeriod"
                          />
                        </div>
                      </div>
                      <div class="mb-3 row" style="text-align: left">
                        <label
                          for="inputMedFordetail"
                              ...
                              <div class="col-sm-8">
                                ...
                                >
                                  <div
                                    class="col"
                                    style="text-align: left"
                                    v-for="medName in editMed"
                                    :key="medName.medId"
                                  >
                                    <label
                                      for="inputMedFordetail"
                                      class="col-sm-10 col-form-label"
                                      >{{ medName.medName }}</label
                                    >
                                    <button
                                      class="btn"
                                      @click="deleteMedfromFormula(medName)"
                                    >
                                      <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        width="16"
                    ...
                    >
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ถ้าคุณต้องการลบ
                            {{ selectedFormula.formulaName }} กรุณากด
                            <b>"ตกลง"</b>
                          </div>
                          <div class="modal-footer">
                            <button
                            ...
                            <button
                              ...
                              class="btn btn-success"
                              data-bs-dismiss="modal"
                              @click="goYesDelete(selectedFormula)"
                            >
                              ตกลง
                            </button>
                          </div>
...
export default {
  ...
  mounted() {
    ...
    axios
      .get(`https://cancer-api.gadoz.dev/AllFormula_Medicine`)
      .then((response) => {
  ...
  methods: {
    ...
    deleteMedfromFormula(med) {
      ...
      axios
        .post(`https://cancer-api.gadoz.dev/deleteMedFromFormula`, data)
        .then((response) => {
          Swal.fire({
            title: "สำเร็จ",
    ...
    goYes() {
      if (this.addMedName == "") {
        ...
        axios
          .post(`https://cancer-api.gadoz.dev/addFormula`, data)
          .then((response) => {
            Swal.fire({
              title: "สำเร็จ",
              text: response.data,
    ...
    overlayModmed(formula) {
      axios
        .get(`https://cancer-api.gadoz.dev/medicine/${formula.formulaId}`)
        .then((response) => {
    ...
    goYesMod() {
      if ((this.editMedName != "") & (this.selectMed != "")) {
        ...
        axios
          .post(`https://cancer-api.gadoz.dev/updateFormula/${formulaId}`, data)
          .then((response) => {
            this.editMed = response.data;
            this.selectMed = [];
          })
    ...
    sortColumn() {
      if (this.sortFormula != "เรียงลำดับตาม ID") {
        ...
        axios
          .post(`https://cancer-api.gadoz.dev/sortFormula`, data)
          .then((response) => {
    ...
    searchFormula() {
      ...
      axios
        .post(`https://cancer-api.gadoz.dev/searchFormula`, data)
        .then((response) => {
    ...
    goYesDelete(selectedFormula) {
      ...
      axios
        .delete(`https://cancer-api.gadoz.dev/deleteFormula/${formulaName}`)
        .then((response) => {
          Swal.fire({
            title: "สำเร็จ",
            text: response.data,
