    ...
    <div className='p-4'>
      <div className="flex flex-wrap gap-4 items-center justify-center">
        {appointments.map((appointment) => (
          <div key={appointment.appointId} className="pt-6">
            <Link to={`/Appointment/PostponeAppointment/${appointment.appointId}`} className="box-sd">
              <div className="text-center text-black shadow-sm">
                <p className='text-sm'>นัดหมายที่ {appointment.appoint_no}</p>
                <h2 className='text-5xl'>{appointment.appointId}</h2>
              </div>
              ...
              <button className='p-3 rounded-full w-20 text-white bg-red-300 border-collapse hover:bg-blue-600 duration-300 hover:drop-shadow-lg'>
